...
%>
	...
	<div class="join_wrap">
		...
		<!-- /이미지 -->
		<!-- 환영합니다 -->
		<p class="text_justjoin"> 
		    <span style="color: green;"><%=session.getAttribute("id")%></span>님의 개인정보 입니다.
		</p>
		<p class="text_guide">
			개인정보를 확인해주세요.
		</p>
		<!-- 2. 게시물 목록 -->
		<form action="myaccount_info_process.jsp" method="post">
		    <table class="main_table">
		        <tr>
		            ...
		            <td class="second_table">
		                <input type="text" class="input_box" id="name" name="name" disabled>
		            </td>
		        </tr>
		        <tr>
		            <td class="first_table">
		            ...
		            <td class="second_table">
		                <input type="text" class="input_box" id="id" name="id" disabled>
		            </td>
		        </tr>
		        <tr>
		            <td class="first_table">
				...
				<tr>
				    <td colspan="2">
				        <input type=submit class="join_btn" onclick="joinChecker()" id="subB" value="수정">
				    </td>
				</tr>
			</table>
		</form>
