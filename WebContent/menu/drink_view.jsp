...
<%
	...
	if(categoryDto.getType().equals("food"))
		response.sendRedirect("food_view.jsp?menu_no=" + menu_no);
...
<body>
			...
			<div class="sub_tit_wrap">
				<div class="sub_tit_inner">
					...
					<ul class="smap">
						...
						<li>
							<a href="drink_list.jsp">음료</a>
						</li>
						<li>
							<img class="arrow" src="/RYANBUCKS_v1.0/common/img/icon_arrow.png" alt="하위메뉴">
						</li>
						<li>
							<a href="drink_list.jsp"><%=categoryDto.getName() %></a>
						</li>
						<li>
							<img class="arrow" src="/RYANBUCKS_v1.0/common/img/icon_arrow.png" alt="하위메뉴">
						</li>
	...
	<script>
		...
		function changeSorting(selectElement) {
    		...
    		location.href = "drink_view.jsp?menu_no=" + <%=menuDto.getNo()%> + "&sort_option=" + sort_option;
